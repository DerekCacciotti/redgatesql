...
INSERT INTO [dbo].[codeCaseProgress] ([codeCaseProgressPK], [CaseProgressCode], [CaseProgressBrief], [CaseProgressDescription], [CaseProgressNote]) VALUES (2, 2.0, 'PA-Stat=1', 'Preassessement-Casestatus=1', NULL)
...
INSERT INTO [dbo].[codeCaseProgress] ([codeCaseProgressPK], [CaseProgressCode], [CaseProgressBrief], [CaseProgressDescription], [CaseProgressNote]) VALUES (6, 6.0, 'PI-Stat=1', 'Preintake-Casestatus=1', NULL)
INSERT INTO [dbo].[codeCaseProgress] ([codeCaseProgressPK], [CaseProgressCode], [CaseProgressBrief], [CaseProgressDescription], [CaseProgressNote]) VALUES (7, 7.0, 'PI-Stat=3', 'Preintake-Casestatus=3', NULL)
INSERT INTO [dbo].[codeCaseProgress] ([codeCaseProgressPK], [CaseProgressCode], [CaseProgressBrief], [CaseProgressDescription], [CaseProgressNote]) VALUES (8, 8.0, 'PI-Stat=2', 'Preintake-Casestatus=2', NULL)
INSERT INTO [dbo].[codeCaseProgress] ([codeCaseProgressPK], [CaseProgressCode], [CaseProgressBrief], [CaseProgressDescription], [CaseProgressNote]) VALUES (9, 9.0, 'ID Contact', 'ID Contact', NULL)
