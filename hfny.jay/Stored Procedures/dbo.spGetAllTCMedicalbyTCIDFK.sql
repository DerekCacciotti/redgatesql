...
left outer join 
	(select AppCode, left(AppCodeText,30) as AppCodeText1 from codeApp where AppCodeGroup='PositiveNegative') lc 
	on tm.leadlevelcode=lc.AppCode
left outer join 
	dbo.codeMedicalReasons mr1
	on tm.MedicalReason1 = mr1.ReasonCode
left outer join
	dbo.codeMedicalReasons mr2
	on tm.MedicalReason2 = mr2.ReasonCode
left outer join 
	dbo.codeMedicalReasons mr3
