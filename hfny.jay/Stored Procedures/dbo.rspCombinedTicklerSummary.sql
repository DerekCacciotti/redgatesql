		...
		from (
			  ...
			  select
				  ...
				  from caseprogram
					  ...
					  left join asq
							   on asq.hvcasefk = hvcasepk
							   and asq.programfk = caseprogram.programfk
			  ...
			  select
				  ...
				  from caseprogram
					  ...
					  inner join codelevel
								on codelevelpk = currentlevelfk
					  left join followup
							   on followup.hvcasefk = hvcasepk
							   and followup.programfk = caseprogram.programfk
