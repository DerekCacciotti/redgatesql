...
-- rspQAReport7_bak3 1, 'summary'	--- for summary page
-- rspQAReport7_bak3 1			--- for main report - location = 1
-- rspQAReport7_bak3 null			--- for main report for all locations
-- =============================================


CREATE procedure [dbo].[rspQAReport7_bak3](
...
DECLARE @tbl4QAReport7_bak3Detail TABLE(
	HVCasePK INT, 
	[PC1ID] [char](13),	
	TCDOB [datetime],
...
INSERT INTO @tbl4QAReport7_bak3Detail(
	HVCasePK,
	[PC1ID],
	TCDOB,
	FormDueDate,
...
UPDATE @tbl4QAReport7_bak3Detail SET TCName = '' WHERE TCName IS NULL



-- Equivelent to csrForm6 in foxpro	
--SELECT DISTINCT HVCasePK  FROM @tbl4QAReport7_bak3Detail



--SELECT * FROM @tbl4QAReport7_bak3Detail  -- Equivelent to csrForm6 in foxpro
--ORDER BY HVCasePK
--ORDER BY Worker 
 
--- rspQAReport7_bak3 1 ,'summary'


 
 DECLARE @tbl4QAReport7_bak3Interval TABLE(
	HVCasePK INT,
	TCIDFK INT,
	Interval CHAR (2)
)
...
INSERT INTO @tbl4QAReport7_bak3Interval
(
HVCasePK,
TCIDFK,
Interval
...
SELECT 
 ...
 FROM @tbl4QAReport7_bak3Detail qa1
 ...
 --SELECT * FROM @tbl4QAReport7_bak3Interval
...
DECLARE @tbl4QAReport7_bak3Expected TABLE(
	HVCasePK INT,
	[PC1ID] [char](13),
	TCDOB [datetime],
	Worker [varchar](200),
...
INSERT INTO @tbl4QAReport7_bak3Expected(
	HVCasePK,
	[PC1ID],
	TCDOB,
	Worker,
 ...
 FROM @tbl4QAReport7_bak3Detail qa1 
 INNER JOIN @tbl4QAReport7_bak3Interval cteIn ON qa1.HVCasePK = cteIn.HVCasePK AND qa1.TCIDPK = cteIn.TCIDFK  -- we will use column 'Interval' next, which we just added
 ...
 --SELECT * FROM @tbl4QAReport7_bak3Expected
 --ORDER BY HVCasePK 
...
DECLARE @tbl4QAReport7_bak3LastASQIntervalCompleted TABLE(
	HVCasePK INT,
	TCIDFK INT,
...
INSERT INTO @tbl4QAReport7_bak3LastASQIntervalCompleted
(
HVCasePK,
TCIDFK,
...
SELECT 
 ...
 -- SELECT * FROM @tbl4QAReport7_bak3LastASQIntervalCompleted
 --ORDER BY HVCasePK 
 ...
 DECLARE @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort TABLE(
	HVCaseFK INT,
	TCIDFK INT, 
	Interval CHAR (2),
...
INSERT INTO @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort
(
	HVCaseFK,
	TCIDFK,
	Interval,
 ...
 SELECT qa3.HVCasePK,
  ...
  FROM @tbl4QAReport7_bak3Detail qa3  
 LEFT JOIN ASQ A ON qa3.TCIDPK = A.TCIDFK 


 
 --SELECT * FROM @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort
 --ORDER BY TCIDFK 
 
 --- rspQAReport7_bak3 1 ,'summary'
 
 
 DECLARE @tbl4QAReport7_bak3NotExpected TABLE(
	HVCasePK INT,
	[PC1ID] [char](13),
	TCDOB [datetime],
	Worker [varchar](200),
...
INSERT INTO @tbl4QAReport7_bak3NotExpected(
	HVCasePK,
	[PC1ID],
	TCDOB,
	Worker,
 ...
 FROM @tbl4QAReport7_bak3Detail qa2 
 INNER JOIN @tbl4QAReport7_bak3Interval cteInExpected ON qa2.HVCasePK = cteInExpected.HVCasePK AND qa2.TCIDPK = cteInExpected.TCIDFK  -- we will use column 'Interval' next, which we just added
 LEFT JOIN @tbl4QAReport7_bak3LastASQIntervalCompleted cteIn2 ON qa2.HVCasePK = cteIn2.HVCasePK -- we will use column 'Interval' next, which we just added
 LEFT JOIN @tbl4QAReport7_bak3Expected easq on easq.hvcasepk = qa2.HVCasePK 
 ...
 LEFT JOIN @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 ON qa4.TCIDFK  = qa2.TCIDPK  AND ((cteIn2.LastASQIntervalCompleted = qa4.Interval) OR (cteIn2.LastASQIntervalCompleted IS NULL))  -- in foxpro i.e. LOCATE FOR ALLTRIM(tc_age)=ALLTRIM(STR(aqs.max_tcage,2,0))
WHERE 
easq.hvcasepk IS NULL 
 
 
 --SELECT * FROM @tbl4QAReport7_bak3NotExpected 
...
-- define a new table variable to store the latest changes
 ...
 DECLARE @tbl4QAReport7_bak3NotExpectedModified TABLE(
	HVCasePK INT,
	[PC1ID] [char](13),
	TCDOB [datetime],
	Worker [varchar](200),
...
SELECT HVCasePK
	 ...
	 CASE
	  ...
	  WHEN((qa04.IntervalExpected = '60' OR qa04.IntervalExpected = '54' OR qa04.IntervalExpected = '48') AND (
		 '60' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)
		  OR
		 '54' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)	  
		 OR
		 '48' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)	  

	  )) THEN 0
	 
	  -- handling optional - 42
	  WHEN((qa04.IntervalExpected = '42' OR qa04.IntervalExpected = '36') AND (
		  '42' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '36' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  		 
	  )) THEN 0
	 
	  -- handling optional - 33
	  WHEN((qa04.IntervalExpected = '33' OR qa04.IntervalExpected = '30') AND (
		  '33' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '30' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  		 
	  )) THEN 0
	 
	  -- handling optional - 27
	  WHEN((qa04.IntervalExpected = '27' OR qa04.IntervalExpected = '24') AND (
		  '27' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '24' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  		 
	  )) THEN 0
	 
	  -- handling optional - 22
	  WHEN((qa04.IntervalExpected = '22' OR qa04.IntervalExpected = '20') AND (
		  '22' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '20' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  		 
	  )) THEN 0
	 
	  -- handling optional - 18
	  WHEN((qa04.IntervalExpected = '18' OR qa04.IntervalExpected = '16') AND (
		  '18' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '16' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  		 
	  )) THEN 0

	 
	  -- handling optional - 14
	  WHEN((qa04.IntervalExpected = '14' OR qa04.IntervalExpected = '12') AND (
		  '14' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '12' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		 	 
	  )) THEN 0	 
	 
	  -- handling optional - 10,09
	  WHEN((qa04.IntervalExpected = '10' OR qa04.IntervalExpected = '09' OR qa04.IntervalExpected = '08') AND (
		  '10' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '09' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '08' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		 	 
	  )) THEN 0	 
	 
	  -- handling optional - 06
	  WHEN((qa04.IntervalExpected = '06' OR qa04.IntervalExpected = '04') AND (
		  '06' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		  OR
		  '04' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
		 	 
	  )) THEN 0	 
	 
	  -- handling optional - 02
	  WHEN((qa04.IntervalExpected = '02') AND (
		  '02' IN (SELECT interval FROM  @tbl4QAReport7_bak3Intervals4AllASQsInOurCohort qa4 WHERE  qa4.TCIDFK  = qa04.TCIDPK)  	
...
FROM @tbl4QAReport7_bak3NotExpected qa04
where 
...
INSERT INTO @tbl4QAReport7_bak3NotExpectedModified(
	HVCasePK,
	[PC1ID],
	TCDOB,
	Worker,
...
--ORDER BY HVCasePK 
 ...
 DECLARE @tbl4QAReport7_bak3NotExpectedMain TABLE(
	HVCasePK INT,
	[PC1ID] [char](13),
	TCDOB [datetime],
	Worker [varchar](200),
...
INSERT INTO @tbl4QAReport7_bak3NotExpectedMain(
	HVCasePK,
	[PC1ID],
	TCDOB,
	Worker,
...
SELECT 
	 ...
	 , IntervalExpected
	 , LastASQIntervalCompleted
 FROM @tbl4QAReport7_bak3NotExpectedModified qa5
...
--SELECT * FROM @tbl4QAReport7_bak3NotExpectedMain
...
IF @ReportType = 'summary'
	...
	SET @numOfALLScreens = (SELECT count(HVCasePK) FROM @tbl4QAReport7_bak3Detail)


	DECLARE @numOfMissingCases INT = 0
	SET @numOfMissingCases = (SELECT count(HVCasePK) FROM @tbl4QAReport7_bak3NotExpectedMain WHERE Missing = 1)
	
	DECLARE @numOfOutOfWindowsORNotReviewedCases INT = 0
	SET @numOfOutOfWindowsORNotReviewedCases = (SELECT count(HVCasePK) FROM @tbl4QAReport7_bak3Expected WHERE OutOfWindow = 1 OR FormReviewed=0)	
...
ELSE
	...
	SELECT
	 ...
	 FROM @tbl4QAReport7_bak3NotExpectedMain qam	 
