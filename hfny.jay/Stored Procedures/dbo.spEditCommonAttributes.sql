...
PBEmergencyAssistanceAtFollowUp = @PBEmergencyAssistanceAtFollowUp, 
PBFoodStamps = @PBFoodStamps, 
PBFoodStampsAmount = @PBFoodStampsAmount, 
PBFoodStampsAtFollowUp = @PBFoodStampsAtFollowUp, 
PBSSI = @PBSSI, 
PBSSIAmount = @PBSSIAmount, 
PBSSIAtFollowUp = @PBSSIAtFollowUp, 
PBTANF = @PBTANF, 
PBTANFAmount = @PBTANFAmount, 
PBTANFAtFollowUp = @PBTANFAtFollowUp, 
PBWIC = @PBWIC, 
PBWICAmount = @PBWICAmount, 
PBWICAtFollowUp = @PBWICAtFollowUp, 
