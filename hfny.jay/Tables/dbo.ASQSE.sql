...
ALTER TABLE [dbo].[ASQSE] WITH NOCHECK ADD
CONSTRAINT [FK_ASQSE_ProgramFK] FOREIGN KEY ([ProgramFK]) REFERENCES [dbo].[HVProgram] ([HVProgramPK])
ALTER TABLE [dbo].[ASQSE] WITH NOCHECK ADD
CONSTRAINT [FK_ASQSE_FSWFK] FOREIGN KEY ([FSWFK]) REFERENCES [dbo].[Worker] ([WorkerPK])
