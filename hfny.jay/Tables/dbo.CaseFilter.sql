...
GO
ALTER TABLE [dbo].[CaseFilter] WITH NOCHECK ADD CONSTRAINT [FK_CaseFilter_CaseCriteriaFK] FOREIGN KEY ([CaseCriteriaFK]) REFERENCES [dbo].[listCaseCriteria] ([listCaseCriteriaPK])
GO
