...
GO
ALTER TABLE [dbo].[listCaseFilterName] WITH NOCHECK ADD CONSTRAINT [FK_listCaseCriteria_ProgramFK] FOREIGN KEY ([ProgramFK]) REFERENCES [dbo].[HVProgram] ([HVProgramPK])
GO
