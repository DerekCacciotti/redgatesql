...
GO
PRINT N'Altering [dbo].[HVLog]'
GO
ALTER TABLE [dbo].[HVLog] ADD
...
ALTER TABLE [dbo].[HVLog] WITH NOCHECK  ADD CONSTRAINT [FK_HVLog_NonPrimaryFSWFK] FOREIGN KEY ([NonPrimaryFSWFK]) REFERENCES [dbo].[Worker([WorkerPK])
ALTER TABLE [dbo].[HVLog] WITH NOCHECK  ADD CONSTRAINT [FK_HVLog_FatherAdvocateFK] FOREIGN KEY ([FatherAdvocateFK]) REFERENCES [dbo].[Worker([WorkerPK])
