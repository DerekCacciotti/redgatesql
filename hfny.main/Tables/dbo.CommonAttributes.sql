...
[CommonAttributesCreator] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[CommonAttributesEditDate] [datetime] NULL,
[CommonAttributesEditor] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_FK_CommonAttributes_FormFK] ON [dbo].[CommonAttributes] ([FormFK]) ON [PRIMARY]
GO
