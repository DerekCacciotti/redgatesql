...
[TrainingDetailCreator] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[TrainingDetailEditDate] [datetime] NULL,
[TrainingDetailEditor] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
