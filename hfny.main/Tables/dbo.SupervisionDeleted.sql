...
[SupervisionDeleteDate] [datetime] NOT NULL,
...
GO
ALTER TABLE [dbo].[SupervisionDeleted] ADD CONSTRAINT [PK__SupervisionDeleted] PRIMARY KEY CLUSTERED  ([SupervisionDeletedPK]) ON [PRIMARY]
GO
