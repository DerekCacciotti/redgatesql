...
ALTER TABLE [dbo].[PHQ9] ADD 
CONSTRAINT [PK_PHQ9] PRIMARY KEY CLUSTERED  ([PHQ9PK]) ON [PRIMARY]
...
ALTER TABLE [dbo].[PHQ9] ADD
CONSTRAINT [FK_PHQ9_ProgramFK] FOREIGN KEY ([ProgramFK]) REFERENCES [dbo].[HVProgram] ([HVProgramPK])
