...
GO
CREATE NONCLUSTERED INDEX [nci_wi_ReportHistory_C5E72E03EA1379792DD06BEA639AF3A5] ON [dbo].[ReportHistory] ([ProgramFK], [UserName]) INCLUDE ([ReportFK], [TimeRun]) ON [PRIMARY]
GO
