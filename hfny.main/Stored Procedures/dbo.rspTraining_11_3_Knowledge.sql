...
, cteAlmostFinal AS (
		...
		, CASE WHEN cteMeetTarget.TopicCode = 17.0 THEN '11-3a. Staff (assessment workers, home visitors and supervisors) receives training in Infant and Child Development within six months of hire'  
			WHEN cteMeetTarget.TopicCode = 19.0 THEN '11-3b. Staff (assessment workers, home visitors and supervisors) receives training in Supporting the Parent-Child Relationship within six months of hire' 
			WHEN cteMeetTarget.TopicCode = 23.0 THEN '11-3c. Staff (assessment workers, home visitors and supervisors) receives training in Staff Related Issues within twelve months of hire' 
			WHEN cteMeetTarget.TopicCode = 25.0 THEN '11-3d. Staff (assessment workers, home visitors and supervisors) receives training in Mental Health within twelve months of hire' 
			END AS TopicName
		, TrainingDate
		, HireDate
		, [Meets Target]
