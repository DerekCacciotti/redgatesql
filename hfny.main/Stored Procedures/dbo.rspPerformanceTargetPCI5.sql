...
-- Description:	gets data for Performance Target report - PCI5. Reducing Parental-Child Dysfunctional Interaction Stress (PCDI)
--				in highly stressed families by the target child's six month birthday
-- rspPerformanceTargetReportSummary 19, '07/01/2012', '09/30/2012', null, null, 0, null
-- =============================================
CREATE procedure [dbo].[rspPerformanceTargetPCI5]
(
    @StartDate      datetime,
    @EndDate		datetime,
...
begin
	...
	cteMain
	as
		(select distinct 'PCI5' as PTCode
					, coh.HVCaseFK 
					, PC1ID
					, OldID
					, TCDOB
