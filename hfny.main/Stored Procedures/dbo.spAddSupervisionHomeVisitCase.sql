...
AS
IF NOT EXISTS (SELECT TOP(1) SupervisionHomeVisitCasePK
FROM SupervisionHomeVisitCase lastRow
WHERE 
...
@TransitionPlanningStatus = lastRow.TransitionPlanningStatus
ORDER BY SupervisionHomeVisitCasePK DESC) 
BEGIN
