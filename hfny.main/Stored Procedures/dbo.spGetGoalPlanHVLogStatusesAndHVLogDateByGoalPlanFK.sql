...
-- =============================================
CREATE PROCEDURE [dbo].[spGetGoalPlanHVLogStatusesAndHVLogDateByGoalPlanFK]
...
BEGIN
	...
	SELECT gphls.GoalPlanHVLogStatusPK, gphls.DevelopmentSinceLastVisit, gphls.GoalProblemSolvingAndPlanEdit, 
		gphls.GoalPlanHVLogStatusCreateDate, gphls.GoalPlanHVLogStatusCreator, gphls.GoalPlanHVLogStatusEditDate,
		gphls.GoalPlanHVLogStatusEditor, gphls.NextStepEdit, gphls.GoalPlanFK, gphls.HVLogFK, hl.VisitStartTime
