...
-- to the supplied HVLogFK
-- =============================================
CREATE PROCEDURE [dbo].[spDeleteAllGoalPlanHVLogStatusbyHVLogFK]
...
BEGIN
	...
	INSERT INTO @tblRowsToBeDeleted
		...
		WHERE HVLogFK = @HVLogFK

	--Delete all the GoalPlanHVLogStatus rows for a specific HVLog
	DELETE 
	FROM GoalPlanHVLogStatus 
	WHERE HVLogFK = @HVLogFK
