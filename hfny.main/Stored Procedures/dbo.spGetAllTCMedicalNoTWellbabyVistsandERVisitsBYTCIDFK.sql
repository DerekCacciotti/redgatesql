...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[spGetAllTCMedicalNoTWellbabyVistsandERVisitsBYTCIDFK] @TCIDFK INT AS 
SELECT tm.*,
...
where TCIDFK=@TCIDFK AND cmi.MedicalItemUsedWhere = 'TM' AND  MedicalItemText LIKE '%TC%'
