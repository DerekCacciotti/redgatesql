...
-- Description:	<report: Credentialing 6-5.C ASQSE>
-- Edit date: 
-- rspASQHistory 1
-- =============================================

CREATE procedure [dbo].[rspCredentialingASQSESummary]
(
...
;with cteMain
	...
	select
		 ...
		 ,case when a.ASQSEInWindow is null then 'Unknown'
			  when a.ASQSEInWindow = 1 then 'In Window' else 'Out of Window' end InWindow
		 ,a.ASQSETCAge [TCAgeCode]
		 ,ISNULL(a.ASQSEReceiving,0) ASQSEReceiving
		from dbo.ASQSE a
