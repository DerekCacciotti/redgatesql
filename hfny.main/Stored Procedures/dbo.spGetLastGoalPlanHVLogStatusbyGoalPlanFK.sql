...
-- =============================================
CREATE PROC [dbo].[spGetLastGoalPlanHVLogStatusbyGoalPlanFK]
...
BEGIN
	...
	SELECT TOP(1) gphls.GoalPlanHVLogStatusPK, gphls.DevelopmentSinceLastVisit, gphls.Challenges, 
		gphls.GoalPlanHVLogStatusCreateDate, gphls.GoalPlanHVLogStatusCreator, gphls.GoalPlanHVLogStatusEditDate,
		gphls.GoalPlanHVLogStatusEditor, gphls.FollowUpAndSupport, gphls.GoalPlanFK, gphls.HVLogFK
